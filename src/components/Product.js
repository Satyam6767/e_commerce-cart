        ...
        <Col>
          <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Stylish dresses, cozy sweaters, trendy jeans, chic blouses, comfy leggings, elegant skirts, fashionable tops, classic shirts, stylish jackets.
              </Card.Text>
              <Link to="/clothes">
                <Button variant="primary">Shop now</Button>
              </Link>
        ...
        <Col>
          <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Browse our latest electronics: smartphones, laptops, TVs, cameras, headphones, and accessories. Shop now and save!
              </Card.Text>
              <Link to="/electronics">
                <Button variant="primary">Shop now</Button>
              </Link>
